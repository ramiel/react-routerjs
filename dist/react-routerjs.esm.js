...
var RouterProvider = function (_a) {
    ...
    var _b = useState(null), currentPath = _b[0], setCurrentPath = _b[1];
    if (!initialized) {
        initialized = true;
...
var Link = function (_a) {
    ...
    return (React.createElement("a", __assign({ href: newHref }, props, { "data-routerjs-ignore": true, onClick: function (e) {
            e.preventDefault();
